...
tfrecord1 = tf.python_io.TFRecordWriter("xiaozhuan1.tfrecords")
tfrecord2 = tf.python_io.TFRecordWriter("jiaguwen1.tfrecords")  # 要生成的文件

tfrecord3 = tf.python_io.TFRecordWriter("xiaozhuantest.tfrecords")
tfrecord4 = tf.python_io.TFRecordWriter("jiaguwentest.tfrecords")  # 要生成的文件
